...
PLIC_PTR_PRIORITY = cast_Bits64AnyPtr 0xc000000

PLIC_PTR_PENDING : AnyPtr
PLIC_PTR_PENDING = cast_Bits64AnyPtr 0xc001000

PLIC_PTR_ENABLE : AnyPtr
PLIC_PTR_ENABLE = cast_Bits64AnyPtr 0xc002000

PLIC_PTR_THRESHOLD : AnyPtr
PLIC_PTR_THRESHOLD  = cast_Bits64AnyPtr 0xc200000
...
set_threshold tsh = do
  let actual_prio = (cast {to=Bits64} tsh) .&. 7
